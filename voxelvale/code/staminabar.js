...
let staminaBorderColor = ["rgba(100,200,100,", "rgba(241,200,23,","rgba(0,0,200,"];
let staminaFillColor = ["rgba(0,200,0,", "rgba(222,220,63,","rgba(0,0,255,"];
let staminaBarBackColor = ["rgba(0,60,0,", "rgba(102,102,51,","rgba(0,0,100,"];
...
function draw_arb_bar(x1, y1, x2, y2, health, maxHealth, borderRadius=40,opacity=1,colorIndex=2){
